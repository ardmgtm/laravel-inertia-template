      ...
      <div ref="modalContent" class="bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700/60 overflow-auto max-w-2xl w-full max-h-full rounded-lg shadow-lg">
        ...
        <form class="border-b border-gray-200 dark:border-gray-700/60">
          <div class="relative">
            ...
            <input :id="searchId" class="w-full dark:text-gray-300 bg-white dark:bg-gray-800 border-0 focus:ring-transparent placeholder-gray-400 dark:placeholder-gray-500 appearance-none py-3 pl-10 pr-4" type="search" placeholder="Search Anything…" ref="searchInput" autocomplete="off"/>
        ...
        <div class="py-4 px-2">
          ...
          <div class="mb-3 last:mb-0">
            ...
            <ul class="text-sm">
              <li>
                <div class="flex items-center p-2 text-gray-800 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700/20 rounded-lg" to="#0" @click="$emit('close-modal')">
